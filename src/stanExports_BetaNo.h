...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BetaNo");
    reader.add_event(62, 60, "end", "model_BetaNo");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BetaNo
  : public stan::model::model_base_crtp<model_BetaNo> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_BetaNo_namespace::model_BetaNo stan_model;
#ifndef USING_R
