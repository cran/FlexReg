...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB1_phi");
    reader.add_event(109, 107, "end", "model_VIB1_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB1_phi
  : public stan::model::model_base_crtp<model_VIB1_phi> {
private:
        int N;
        vector_d y;
        int K;
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(b2, 
                            ...
                            (((1 - get_base1(mu, i, "mu", 1)) * get_base1(phi, i, "phi", 1)) * k), 
                            "assigning variable b2");
                current_statement_begin__ = 57;
                stan::model::assign(a2, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((get_base1(mu, i, "mu", 1) * get_base1(phi, i, "phi", 1)) * k), 
...
typedef model_VIB1_phi_namespace::model_VIB1_phi stan_model;
#ifndef USING_R
