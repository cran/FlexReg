...
static constexpr std::array<const char*, 71> locations_array__ =
  ...
  " (in 'string', line 41, column 2 to column 55)",
  " (in 'string', line 43, column 2 to column 25)",
  " (in 'string', line 44, column 2 to column 29)",
  " (in 'string', line 46, column 2 to column 25)",
  " (in 'string', line 47, column 2 to column 29)",
  " (in 'string', line 39, column 15 to line 48, column 2)",
  " (in 'string', line 39, column 1 to line 48, column 2)",
  " (in 'string', line 70, column 2 to line 71, column 55)",
  " (in 'string', line 69, column 14 to line 72, column 2)",
  " (in 'string', line 69, column 1 to line 72, column 2)",
  " (in 'string', line 52, column 2 to column 81)",
  " (in 'string', line 53, column 2 to column 81)",
  " (in 'string', line 54, column 1 to column 44)",
  " (in 'string', line 59, column 3 to column 40)",
  " (in 'string', line 58, column 7 to line 59, column 40)",
  " (in 'string', line 57, column 3 to column 40)",
  " (in 'string', line 56, column 2 to line 59, column 40)",
  " (in 'string', line 55, column 16 to line 60, column 2)",
  " (in 'string', line 55, column 1 to line 60, column 2)",
  " (in 'string', line 63, column 1 to line 64, column 72)",
  " (in 'string', line 62, column 14 to line 65, column 2)",
  " (in 'string', line 62, column 1 to line 65, column 2)",
  ...
  " (in 'string', line 7, column 1 to column 27)",
  " (in 'string', line 8, column 1 to column 30)",
  " (in 'string', line 9, column 1 to column 31)",
  " (in 'string', line 10, column 1 to column 29)",
  " (in 'string', line 11, column 1 to column 29)",
  " (in 'string', line 12, column 1 to column 24)",
  " (in 'string', line 13, column 1 to column 24)",
...
public:
  ...
  model_FBB(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    try {
      ...
      context__.validate_dims("data initialization", "hyper_theta_a",
        "double", std::vector<size_t>{});
      hyper_theta_a = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 58;
      hyper_theta_a = context__.vals_r("hyper_theta_a")[(1 - 1)];
      current_statement__ = 58;
      stan::math::check_greater_or_equal(function__, "hyper_theta_a",
        hyper_theta_a, 0);
      current_statement__ = 59;
      context__.validate_dims("data initialization", "hyper_theta_b",
        "double", std::vector<size_t>{});
      hyper_theta_b = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 59;
      hyper_theta_b = context__.vals_r("hyper_theta_b")[(1 - 1)];
      current_statement__ = 59;
      stan::math::check_greater_or_equal(function__, "hyper_theta_b",
        hyper_theta_b, 0);
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_FBB_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        stan::model::assign(lambda1,
          ...
          stan::math::fmin(
            ...
            (1 - p))))), "assigning variable lambda1",
        ...
        stan::model::assign(lambda2,
          ...
          stan::math::fmin(
            (stan::model::rvalue(mu, "mu", stan::model::index_uni(i)) / p),
            ((1 - stan::model::rvalue(mu, "mu", stan::model::index_uni(i))) /
            (1 - p))))), "assigning variable lambda2",
          stan::model::index_uni(i));
      ...
      stan::math::check_greater_or_equal(function__, "phi", phi, 0);
      {
        ...
        lp_accum__.add(stan::math::beta_lpdf<propto__>(theta, hyper_theta_a,
                         hyper_theta_b));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_FBB_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "theta", "w", "p"};
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"mu", "lambda1", "lambda2", "b1", "b2", "a1", "a2", "phi"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"w\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
