...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FBB");
    reader.add_event(90, 88, "end", "model_FBB");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FBB
  : public stan::model::model_base_crtp<model_FBB> {
private:
        int N;
        std::vector<int> n;
        std::vector<int> y;
...
public:
    model_FBB(stan::io::var_context& context__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(lambda1, 
                            ...
                            (get_base1(mu, i, "mu", 1) + (((1 - p) * w) * stan::math::fmin((get_base1(mu, i, "mu", 1) / p), ((1 - get_base1(mu, i, "mu", 1)) / (1 - p))))), 
                            "assigning variable lambda1");
                current_statement_begin__ = 47;
                stan::model::assign(lambda2, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(mu, i, "mu", 1) - ((p * w) * stan::math::fmin((get_base1(mu, i, "mu", 1) / p), ((1 - get_base1(mu, i, "mu", 1)) / (1 - p))))), 
            ...
            lp_accum__.add(beta_log<propto__>(w, 1, 1));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(log_mix(p, beta_binomial_log(get_base1(y, i, "y", 1), get_base1(n, i, "n", 1), get_base1(a1, i, "a1", 1), get_base1(b1, i, "b1", 1)), beta_binomial_log(get_base1(y, i, "y", 1), get_base1(n, i, "n", 1), get_base1(a2, i, "a2", 1), get_base1(b2, i, "b2", 1))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            log_mix(p, beta_binomial_log(get_base1(y, i, "y", 1), get_base1(n, i, "n", 1), get_base1(a1, i, "a1", 1), get_base1(b1, i, "b1", 1)), beta_binomial_log(get_base1(y, i, "y", 1), get_base1(n, i, "n", 1), get_base1(a2, i, "a2", 1), get_base1(b2, i, "b2", 1))), 
...
typedef model_FBB_namespace::model_FBB stan_model;
#ifndef USING_R
