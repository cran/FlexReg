...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta01");
    reader.add_event(122, 120, "end", "model_Beta01");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta01
  : public stan::model::model_base_crtp<model_Beta01> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_Beta01_namespace::model_Beta01 stan_model;
#ifndef USING_R
