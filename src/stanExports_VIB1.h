...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB1");
    reader.add_event(96, 94, "end", "model_VIB1");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB1
  : public stan::model::model_base_crtp<model_VIB1> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_VIB1_namespace::model_VIB1 stan_model;
#ifndef USING_R
