...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FB01");
    reader.add_event(138, 136, "end", "model_FB01");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FB01
  : public stan::model::model_base_crtp<model_FB01> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_FB01_namespace::model_FB01 stan_model;
#ifndef USING_R
