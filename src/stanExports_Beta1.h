...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta1");
    reader.add_event(87, 85, "end", "model_Beta1");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta1
  : public stan::model::model_base_crtp<model_Beta1> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_Beta1_namespace::model_Beta1 stan_model;
#ifndef USING_R
