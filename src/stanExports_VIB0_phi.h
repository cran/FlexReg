...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB0_phi");
    reader.add_event(109, 107, "end", "model_VIB0_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB0_phi
  : public stan::model::model_base_crtp<model_VIB0_phi> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_VIB0_phi_namespace::model_VIB0_phi stan_model;
#ifndef USING_R
