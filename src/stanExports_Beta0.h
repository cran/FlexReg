...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta0");
    reader.add_event(87, 85, "end", "model_Beta0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta0
  : public stan::model::model_base_crtp<model_Beta0> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_Beta0_namespace::model_Beta0 stan_model;
#ifndef USING_R
