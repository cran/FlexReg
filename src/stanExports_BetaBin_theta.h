...
public:
  ...
  inline std::string model_name() const final { return "model_BetaBin_theta"; }
  ...
  model_BetaBin_theta(stan::io::var_context& context__,
    ...
    try {
      ...
      context__.validate_dims("data initialization","link_code_theta","int",
          context__.to_vec());
      ...
      current_statement__ = 60;
      current_statement__ = 60;
      check_greater_or_equal(function__, "link_code_theta", link_code_theta,
                             1);
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_BetaBin_theta_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      if (logical_eq(link_code_theta, 1)) {
        current_statement__ = 20;
        assign(theta, nil_index_list(), inv_logit(multiply(Z, psi)),
          "assigning variable theta");
      } else {
        current_statement__ = 19;
        if (logical_eq(link_code_theta, 2)) {
          current_statement__ = 18;
          assign(theta, nil_index_list(), Phi(multiply(Z, psi)),
            "assigning variable theta");
        } else {
          current_statement__ = 17;
          if (logical_eq(link_code_theta, 3)) {
            current_statement__ = 16;
            assign(theta, nil_index_list(), inv_cloglog(multiply(Z, psi)),
              "assigning variable theta");
          } else {
            current_statement__ = 15;
            if (logical_eq(link_code_theta, 4)) {
              current_statement__ = 14;
              assign(theta, nil_index_list(),
                stan::math::exp(minus(stan::math::exp(multiply(Z, psi)))),
                "assigning variable theta");
            } 
          }
        }
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        assign(phi, cons_list(index_uni(i), nil_index_list()),
          ((1 - theta[(i - 1)]) / theta[(i - 1)]), "assigning variable phi");
      }
                               ...
                               0);}
      {
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          lp_accum__.add(
            (((((stan::math::lgamma(phi[(i - 1)]) -
                  stan::math::lgamma((phi[(i - 1)] * mu[(i - 1)]))) -
                 stan::math::lgamma((phi[(i - 1)] * (1 - mu[(i - 1)])))) +
                stan::math::lgamma(
                  ((phi[(i - 1)] * mu[(i - 1)]) + y[(i - 1)]))) +
               stan::math::lgamma(
                 (((phi[(i - 1)] * (1 - mu[(i - 1)])) + n[(i - 1)]) -
                   y[(i - 1)]))) -
              stan::math::lgamma((phi[(i - 1)] + n[(i - 1)]))));}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
...
(void) function__;  // suppress unused var warning
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        assign(log_lik, cons_list(index_uni(i), nil_index_list()),
          ((((((((stan::math::lgamma((n[(i - 1)] + 1)) -
                ...
                stan::math::lgamma((phi[(i - 1)] * mu[(i - 1)]))) -
               stan::math::lgamma((phi[(i - 1)] * (1 - mu[(i - 1)])))) +
              stan::math::lgamma(((phi[(i - 1)] * mu[(i - 1)]) + y[(i - 1)])))
             +
             stan::math::lgamma(
               (((phi[(i - 1)] * (1 - mu[(i - 1)])) + n[(i - 1)]) -
                 y[(i - 1)]))) -
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"psi\",\"type\":{\"name\":\"vector\",\"length\":" << H << "},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"theta\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
