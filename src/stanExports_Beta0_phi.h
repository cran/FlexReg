...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta0_phi");
    reader.add_event(98, 96, "end", "model_Beta0_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta0_phi
  : public stan::model::model_base_crtp<model_Beta0_phi> {
private:
        int N;
        vector_d y;
        int K;
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 0))) {
                    ...
                    lp_accum__.add((log1m(get_base1(q0, i, "q0", 1)) + beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1))));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 0))) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (log1m(get_base1(q0, i, "q0", 1)) + beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1))), 
                                "assigning variable log_lik");
                }
            }
...
typedef model_Beta0_phi_namespace::model_Beta0_phi stan_model;
#ifndef USING_R
