...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Bin");
    reader.add_event(56, 54, "end", "model_Bin");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Bin
  : public stan::model::model_base_crtp<model_Bin> {
private:
        int N;
        std::vector<int> n;
        std::vector<int> y;
...
public:
    model_Bin(stan::io::var_context& context__,
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(((get_base1(y, i, "y", 1) * stan::math::log(get_base1(mu, i, "mu", 1))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log((1 - get_base1(mu, i, "mu", 1))))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(log_lik, 
                            ...
                            ((((stan::math::lgamma((get_base1(n, i, "n", 1) + 1)) - stan::math::lgamma((get_base1(y, i, "y", 1) + 1))) - stan::math::lgamma(((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) + 1))) + (get_base1(y, i, "y", 1) * stan::math::log(get_base1(mu, i, "mu", 1)))) + ((get_base1(n, i, "n", 1) - get_base1(y, i, "y", 1)) * stan::math::log((1 - get_base1(mu, i, "mu", 1))))), 
...
typedef model_Bin_namespace::model_Bin stan_model;
#ifndef USING_R
