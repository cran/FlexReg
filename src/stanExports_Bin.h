...
public:
  ...
  inline std::string model_name() const final { return "model_Bin"; }
  ...
  model_Bin(stan::io::var_context& context__, unsigned int random_seed__ = 0,
    ...
    static const char* function__ = "model_Bin_namespace::model_Bin";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_Bin_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
        ...
        check_less_or_equal(function__, "mu[sym1__]", mu[(sym1__ - 1)], 1);}
      {
        ...
        for (int i = 1; i <= N; ++i) {
          ...
          lp_accum__.add(
            ((y[(i - 1)] * stan::math::log(mu[(i - 1)])) +
              ((n[(i - 1)] - y[(i - 1)]) *
                stan::math::log((1 - mu[(i - 1)])))));}
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_Bin_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        assign(log_lik, cons_list(index_uni(i), nil_index_list()),
          ((((stan::math::lgamma((n[(i - 1)] + 1)) -
             ...
             (y[(i - 1)] * stan::math::log(mu[(i - 1)]))) +
            ((n[(i - 1)] - y[(i - 1)]) * stan::math::log((1 - mu[(i - 1)])))),
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << N << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
