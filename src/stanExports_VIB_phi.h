...
namespace model_VIB_phi_namespace {
...
static constexpr std::array<const char*, 77> locations_array__ =
  ...
  " (in 'string', line 36, column 6 to line 37, column 27)",
  " (in 'string', line 35, column 2 to column 29)",
  " (in 'string', line 34, column 6 to line 37, column 27)",
  " (in 'string', line 33, column 2 to column 21)",
  " (in 'string', line 32, column 6 to line 37, column 27)",
  " (in 'string', line 31, column 2 to column 27)",
  " (in 'string', line 30, column 1 to line 37, column 27)",
  " (in 'string', line 41, column 2 to column 24)",
  " (in 'string', line 40, column 6 to line 41, column 24)",
  " (in 'string', line 39, column 2 to column 21)",
  " (in 'string', line 38, column 1 to line 41, column 24)",
  " (in 'string', line 44, column 1 to column 28)",
  " (in 'string', line 45, column 1 to column 24)",
  " (in 'string', line 47, column 1 to column 28)",
  " (in 'string', line 48, column 1 to column 24)",
  " (in 'string', line 42, column 15 to line 49, column 2)",
  " (in 'string', line 42, column 1 to line 49, column 2)",
  " (in 'string', line 75, column 2 to line 76, column 57)",
  " (in 'string', line 74, column 14 to line 77, column 2)",
  " (in 'string', line 74, column 1 to line 77, column 2)",
  " (in 'string', line 52, column 2 to column 81)",
  " (in 'string', line 53, column 2 to column 81)",
  " (in 'string', line 59, column 2 to column 39)",
  " (in 'string', line 58, column 6 to line 59, column 39)",
  " (in 'string', line 57, column 2 to column 39)",
  " (in 'string', line 56, column 1 to line 59, column 39)",
  " (in 'string', line 55, column 16 to line 60, column 2)",
  " (in 'string', line 55, column 1 to line 60, column 2)",
  " (in 'string', line 65, column 2 to column 37)",
  " (in 'string', line 64, column 6 to line 65, column 37)",
  " (in 'string', line 63, column 2 to column 37)",
  " (in 'string', line 62, column 1 to line 65, column 37)",
  " (in 'string', line 61, column 16 to line 66, column 2)",
  " (in 'string', line 61, column 1 to line 66, column 2)",
  " (in 'string', line 69, column 1 to line 70, column 57)",
  " (in 'string', line 68, column 1 to line 70, column 57)",
...
class model_VIB_phi final : public model_base_crtp<model_VIB_phi> {
private:
  int N;
  ...
  Eigen::Matrix<double,-1,1> hyperparam_k_data__;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,1>> hyperparam_k{nullptr, 0};
public:
  ~model_VIB_phi() {}
  model_VIB_phi(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_VIB_phi_namespace::model_VIB_phi";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      context__.validate_dims("data initialization", "hyperparam_k",
        "double", std::vector<size_t>{static_cast<size_t>(2)});
      hyperparam_k_data__ = Eigen::Matrix<double,-1,1>::Constant(2,
                              std::numeric_limits<double>::quiet_NaN());
      new (&hyperparam_k)
        Eigen::Map<Eigen::Matrix<double,-1,1>>(hyperparam_k_data__.data(), 2);
      {
        std::vector<local_scalar_t__> hyperparam_k_flat__;
        current_statement__ = 67;
        hyperparam_k_flat__ = context__.vals_r("hyperparam_k");
        current_statement__ = 67;
        pos__ = 1;
        current_statement__ = 67;
        for (int sym1__ = 1; sym1__ <= 2; ++sym1__) {
          current_statement__ = 67;
          stan::model::assign(hyperparam_k, hyperparam_k_flat__[(pos__ - 1)],
            "assigning variable hyperparam_k", stan::model::index_uni(sym1__));
          current_statement__ = 67;
          pos__ = (pos__ + 1);
        }
      }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_VIB_phi_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      stan::math::check_greater_or_equal(function__, "a2", a2, 0);
      {
        ...
        lp_accum__.add(stan::math::beta_lpdf<propto__>(k,
                         (stan::model::rvalue(hyperparam_k, "hyperparam_k",
                            stan::model::index_uni(1)) *
                         stan::model::rvalue(hyperparam_k, "hyperparam_k",
                           stan::model::index_uni(2))), ((1 -
                         stan::model::rvalue(hyperparam_k, "hyperparam_k",
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_VIB_phi_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "psi", "k", "p"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"mu", "phi", "b1", "b2", "a1", "a2"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"psi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(H) + "},\"block\":\"parameters\"},{\"name\":\"k\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_VIB_phi_namespace::model_VIB_phi;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_VIB_phi_namespace::profiles__;
}
#endif
#endif
