...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB01");
    reader.add_event(132, 130, "end", "model_VIB01");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB01
  : public stan::model::model_base_crtp<model_VIB01> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_VIB01_namespace::model_VIB01 stan_model;
#ifndef USING_R
