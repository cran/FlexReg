...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FBB_theta");
    reader.add_event(111, 109, "end", "model_FBB_theta");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FBB_theta
  : public stan::model::model_base_crtp<model_FBB_theta> {
private:
        int N;
        std::vector<int> n;
        std::vector<int> y;
...
typedef model_FBB_theta_namespace::model_FBB_theta stan_model;
#ifndef USING_R
