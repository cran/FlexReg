...
static constexpr std::array<const char*, 63> locations_array__ =
  ...
  " (in 'string', line 63, column 1 to column 19)",
  " (in 'string', line 33, column 2 to column 27)",
  " (in 'string', line 32, column 6 to line 33, column 27)",
  " (in 'string', line 31, column 2 to column 29)",
  " (in 'string', line 30, column 6 to line 33, column 27)",
  " (in 'string', line 29, column 2 to column 21)",
  " (in 'string', line 28, column 6 to line 33, column 27)",
  " (in 'string', line 27, column 2 to column 27)",
  " (in 'string', line 26, column 1 to line 33, column 27)",
  " (in 'string', line 36, column 1 to column 25)",
  " (in 'string', line 37, column 1 to column 21)",
  " (in 'string', line 39, column 1 to column 23)",
  " (in 'string', line 40, column 1 to column 19)",
  " (in 'string', line 34, column 15 to line 41, column 2)",
  " (in 'string', line 34, column 1 to line 41, column 2)",
  " (in 'string', line 65, column 2 to line 66, column 57)",
  " (in 'string', line 64, column 14 to line 67, column 2)",
  " (in 'string', line 64, column 1 to line 67, column 2)",
  " (in 'string', line 44, column 2 to column 81)",
  " (in 'string', line 45, column 2 to column 81)",
  " (in 'string', line 50, column 1 to column 30)",
  " (in 'string', line 49, column 6 to line 50, column 30)",
  " (in 'string', line 48, column 1 to column 34)",
  " (in 'string', line 47, column 1 to line 50, column 30)",
  ...
  " (in 'string', line 59, column 1 to line 60, column 57)",
  " (in 'string', line 58, column 1 to line 60, column 57)",
...
class model_VIB final : public model_base_crtp<model_VIB> {
private:
  int N;
...
public:
  ~model_VIB() {}
  model_VIB(stan::io::var_context& context__, unsigned int random_seed__ = 0,
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    // suppress unused var warning
    (void) DUMMY_VAR__;
    static constexpr const char* function__ = "model_VIB_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_VIB_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "phi", "k", "p"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"mu", "b1", "b2", "a1", "a2"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"k\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_VIB_namespace::model_VIB;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_VIB_namespace::profiles__;
}
#endif
#endif
