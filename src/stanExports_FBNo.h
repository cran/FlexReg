...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FBNo");
    reader.add_event(81, 79, "end", "model_FBNo");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FBNo
  : public stan::model::model_base_crtp<model_FBNo> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_FBNo_namespace::model_FBNo stan_model;
#ifndef USING_R
