...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta01_phi");
    reader.add_event(134, 132, "end", "model_Beta01_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta01_phi
  : public stan::model::model_base_crtp<model_Beta01_phi> {
private:
        int N;
        vector_d y;
        int K;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(b, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((1 - get_base1(mu, i, "mu", 1)) * get_base1(phi, i, "phi", 1)), 
                            "assigning variable b");
                current_statement_begin__ = 64;
                stan::model::assign(a, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(mu, i, "mu", 1) * get_base1(phi, i, "phi", 1)), 
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 1))) {
                    ...
                    if (as_bool(logical_eq(get_base1(y, i, "y", 1), 0))) {
                        ...
                        lp_accum__.add((stan::math::log(((1 - get_base1(q0, i, "q0", 1)) - get_base1(q1, i, "q1", 1))) + beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1))));
                    }
                }
            }
        } catch (const std::exception& e) {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 1))) {
                    ...
                    if (as_bool(logical_eq(get_base1(y, i, "y", 1), 0))) {
                        ...
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                    (stan::math::log(((1 - get_base1(q0, i, "q0", 1)) - get_base1(q1, i, "q1", 1))) + beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1))), 
                                    "assigning variable log_lik");
                    }
                }
            }
...
typedef model_Beta01_phi_namespace::model_Beta01_phi stan_model;
#ifndef USING_R
