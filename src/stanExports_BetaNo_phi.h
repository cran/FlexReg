...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BetaNo_phi");
    reader.add_event(72, 70, "end", "model_BetaNo_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BetaNo_phi
  : public stan::model::model_base_crtp<model_BetaNo_phi> {
private:
        int N;
        vector_d y;
        int K;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                lp_accum__.add(beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            beta_log(get_base1(y, i, "y", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1)), 
...
typedef model_BetaNo_phi_namespace::model_BetaNo_phi stan_model;
#ifndef USING_R
