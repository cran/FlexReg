...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FB1_phi");
    reader.add_event(115, 113, "end", "model_FB1_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FB1_phi
  : public stan::model::model_base_crtp<model_FB1_phi> {
private:
        int N;
        vector_d y;
        int K;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            stan::math::assign(q1, inv_logit(multiply(X1, omega1)));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 1))) {
                    ...
                    lp_accum__.add((log1m(get_base1(q1, i, "q1", 1)) + log_mix(p, beta_log(get_base1(y, i, "y", 1), get_base1(a2, i, "a2", 1), get_base1(b2, i, "b2", 1)), beta_log(get_base1(y, i, "y", 1), get_base1(a1, i, "a1", 1), get_base1(b1, i, "b1", 1)))));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(y, i, "y", 1), 1))) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                (log1m(get_base1(q1, i, "q1", 1)) + log_mix(p, beta_log(get_base1(y, i, "y", 1), get_base1(a2, i, "a2", 1), get_base1(b2, i, "b2", 1)), beta_log(get_base1(y, i, "y", 1), get_base1(a1, i, "a1", 1), get_base1(b1, i, "b1", 1)))), 
                                "assigning variable log_lik");
                }
            }
...
typedef model_FB1_phi_namespace::model_FB1_phi stan_model;
#ifndef USING_R
