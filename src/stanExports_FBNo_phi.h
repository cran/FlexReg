...
namespace model_FBNo_phi_namespace {
...
static constexpr std::array<const char*, 82> locations_array__ =
  ...
  " (in 'string', line 30, column 1 to column 27)",
  " (in 'string', line 75, column 1 to column 19)",
  " (in 'string', line 38, column 2 to column 27)",
  " (in 'string', line 37, column 6 to line 38, column 27)",
  " (in 'string', line 36, column 2 to column 29)",
  " (in 'string', line 35, column 6 to line 38, column 27)",
  " (in 'string', line 34, column 2 to column 21)",
  " (in 'string', line 33, column 6 to line 38, column 27)",
  " (in 'string', line 32, column 2 to column 27)",
  " (in 'string', line 31, column 1 to line 38, column 27)",
  " (in 'string', line 42, column 2 to column 24)",
  " (in 'string', line 41, column 6 to line 42, column 24)",
  " (in 'string', line 40, column 2 to column 21)",
  " (in 'string', line 39, column 1 to line 42, column 24)",
  ...
  " (in 'string', line 49, column 1 to column 27)",
  " (in 'string', line 51, column 1 to column 31)",
  " (in 'string', line 52, column 1 to column 27)",
  " (in 'string', line 43, column 15 to line 53, column 2)",
  " (in 'string', line 43, column 1 to line 53, column 2)",
  " (in 'string', line 77, column 2 to line 78, column 57)",
  " (in 'string', line 76, column 14 to line 79, column 2)",
  " (in 'string', line 76, column 1 to line 79, column 2)",
  ...
  " (in 'string', line 66, column 6 to line 67, column 37)",
  " (in 'string', line 65, column 2 to column 37)",
  " (in 'string', line 64, column 1 to line 67, column 37)",
  " (in 'string', line 63, column 16 to line 68, column 2)",
  " (in 'string', line 63, column 1 to line 68, column 2)",
  " (in 'string', line 71, column 1 to line 72, column 57)",
  " (in 'string', line 70, column 1 to line 72, column 57)",
...
class model_FBNo_phi final : public model_base_crtp<model_FBNo_phi> {
private:
  int N;
...
public:
  ~model_FBNo_phi() {}
  model_FBNo_phi(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_FBNo_phi_namespace::model_FBNo_phi";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = K + H + 1 + 1;
  }
  inline std::string model_name() const final {
    return "model_FBNo_phi";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_FBNo_phi_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_FBNo_phi_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "psi", "w", "p"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"psi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(H) + "},\"block\":\"parameters\"},{\"name\":\"w\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"p\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"lambda2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a2\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"wtilde\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((K + H) + 1) + 1);
...
using stan_model = model_FBNo_phi_namespace::model_FBNo_phi;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_FBNo_phi_namespace::profiles__;
}
#endif
#endif
