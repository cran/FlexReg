...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FBNo_phi");
    reader.add_event(90, 88, "end", "model_FBNo_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FBNo_phi
  : public stan::model::model_base_crtp<model_FBNo_phi> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_FBNo_phi_namespace::model_FBNo_phi stan_model;
#ifndef USING_R
