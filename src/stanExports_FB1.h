...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FB1");
    reader.add_event(102, 100, "end", "model_FB1");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FB1
  : public stan::model::model_base_crtp<model_FB1> {
private:
        int N;
        vector_d y;
        int K;
        ...
        double hyper_phi;
public:
    model_FB1(stan::io::var_context& context__,
...
typedef model_FB1_namespace::model_FB1 stan_model;
#ifndef USING_R
