...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIBNo_phi");
    reader.add_event(87, 85, "end", "model_VIBNo_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIBNo_phi
  : public stan::model::model_base_crtp<model_VIBNo_phi> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_VIBNo_phi_namespace::model_VIBNo_phi stan_model;
#ifndef USING_R
