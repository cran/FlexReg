...
namespace model_VIBNo_phi_namespace {
...
static constexpr std::array<const char*, 73> locations_array__ =
  ...
  " (in 'string', line 38, column 6 to line 39, column 24)",
  " (in 'string', line 37, column 2 to column 21)",
  " (in 'string', line 36, column 1 to line 39, column 24)",
...
class model_VIBNo_phi final : public model_base_crtp<model_VIBNo_phi> {
private:
  int N;
...
public:
  ~model_VIBNo_phi() {}
  model_VIBNo_phi(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_VIBNo_phi_namespace::model_VIBNo_phi";
    // suppress unused var warning
    (void) function__;
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_VIBNo_phi_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_VIBNo_phi_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_VIBNo_phi_namespace::model_VIBNo_phi;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_VIBNo_phi_namespace::profiles__;
}
#endif
#endif
