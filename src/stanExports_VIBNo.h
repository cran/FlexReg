...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIBNo");
    reader.add_event(75, 73, "end", "model_VIBNo");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIBNo
  : public stan::model::model_base_crtp<model_VIBNo> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_VIBNo_namespace::model_VIBNo stan_model;
#ifndef USING_R
