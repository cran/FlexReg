...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FB0");
    reader.add_event(103, 101, "end", "model_FB0");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FB0
  : public stan::model::model_base_crtp<model_FB0> {
private:
        int N;
        vector_d y;
        int K;
        ...
        double hyper_phi;
public:
    model_FB0(stan::io::var_context& context__,
...
typedef model_FB0_namespace::model_FB0 stan_model;
#ifndef USING_R
