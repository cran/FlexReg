...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_FB0_phi");
    reader.add_event(115, 113, "end", "model_FB0_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_FB0_phi
  : public stan::model::model_base_crtp<model_FB0_phi> {
private:
        int N;
        vector_d y;
        int K;
...
typedef model_FB0_phi_namespace::model_FB0_phi stan_model;
#ifndef USING_R
