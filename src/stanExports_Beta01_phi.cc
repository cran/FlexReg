...
#include "stanExports_Beta01_phi.h"

RCPP_MODULE(stan_fit4Beta01_phi_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_Beta01_phi")
