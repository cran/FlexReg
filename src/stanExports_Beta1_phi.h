...
namespace model_Beta1_phi_namespace {
...
static constexpr std::array<const char*, 87> locations_array__ =
  ...
  " (in 'string', line 45, column 1 to column 25)",
  " (in 'string', line 46, column 1 to column 21)",
  " (in 'string', line 44, column 14 to line 47, column 1)",
  " (in 'string', line 44, column 0 to line 47, column 1)",
  ...
  " (in 'string', line 60, column 6 to line 61, column 43)",
  " (in 'string', line 59, column 2 to column 43)",
  " (in 'string', line 58, column 1 to line 61, column 43)",
  " (in 'string', line 57, column 17 to line 62, column 2)",
...
class model_Beta1_phi final : public model_base_crtp<model_Beta1_phi> {
private:
  int N;
...
public:
  ~model_Beta1_phi() {}
  model_Beta1_phi(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Beta1_phi_namespace::model_Beta1_phi";
    // suppress unused var warning
    (void) function__;
    ...
    num_params_r__ = K + K1 + H;
  }
  inline std::string model_name() const final {
    return "model_Beta1_phi";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Beta1_phi_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Beta1_phi_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"beta", "omega1", "psi"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"mu", "phi", "a", "b", "q1"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"omega1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K1) + "},\"block\":\"parameters\"},{\"name\":\"psi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(H) + "},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"phi\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"a\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"b\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"q1\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = ((K + K1) + H);
...
using stan_model = model_Beta1_phi_namespace::model_Beta1_phi;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Beta1_phi_namespace::profiles__;
}
#endif
#endif
